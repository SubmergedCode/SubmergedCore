 ...
 */
package uk.submergedcode.SubmergedCore.config.annotation;
...
import uk.submergedcode.SubmergedCore.config.deserialiser.DefaultConfigMapper;

/**
 * Repersents a class that is serialised in a config file by the
 * SubmergedCore {@link ConfigFactory} as a element inside the file.
 *
